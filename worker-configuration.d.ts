/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6ae583c1c68c77780f5b064325f54ab)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	APP_URL: "https://app.extinsafe.com.ar" | "http://localhost:3000";
	DATABASE_URL: string;
...
declare namespace Cloudflare {
	interface ProductionEnv {
		MEDIA: R2Bucket;
		DB: D1Database;
		APP_URL: "https://app.extinsafe.com.ar";
		DATABASE_URL: string;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "DATABASE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
